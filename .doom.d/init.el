...
(doom! :input
       ...
       ;;god               ; (evil is better) run Emacs commands without modifier keys
       ...
       ; grammar         ; (too much for programming, good for writing) tasing grammar mistake every you make
